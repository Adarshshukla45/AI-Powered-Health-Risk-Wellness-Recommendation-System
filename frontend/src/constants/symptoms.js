/**
 * Canonical symptom vocabulary — MUST stay in sync with
 * ml-service/src/symptom_vocab.py (CANONICAL_SYMPTOMS). This mirrors
 * that list so the structured symptom picker only ever sends tokens
 * the ML model actually has a feature for.
 */
